...
function serializeChildBox(
  ...
  return {
    ...
    weightOverride: Boolean(box.weight_override),
    weight_override: Boolean(box.weight_override),
    weightOverrideReason: box.weight_override_reason ?? null,
    weight_override_reason: box.weight_override_reason ?? null,
    heavyPackage: Boolean(box.heavy_package_flag),
    heavy_package_flag: Boolean(box.heavy_package_flag),
      ...
      select: {
        ...
        outbound_boxes: {
          select: {
            ...
            weight_override_reason: true,
            heavy_package_flag: true,
            contents: true,
